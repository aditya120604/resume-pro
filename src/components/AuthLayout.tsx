          ...
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div className="mb-10 flex items-center">
              <Link to="/" className="flex items-center">
                <FileText className="h-8 w-8 text-resume-primary mr-2" />
                <span className="text-2xl font-bold text-resume-dark">ResumePro</span>
              </Link>
            </div>
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-resume-dark">{title}</h2>
